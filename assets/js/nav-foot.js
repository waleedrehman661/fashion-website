...
<nav class="navbar ms-auto me-auto  navbar-expand-lg navbar-light py-3 px-4 bg-light W-100">
        <div class="container-fluid"><img class="nav-logo" src="assets/images/Untitled_design__2_-removebg-preview (1).png" alt="">
          ...
          <div class="collapse navbar-collapse"  id="navbarSupportedContent">
            <ul class="navbar-nav me-5 ms-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link me-2 text-uppercase active" aria-current="page" href="home.html">Home</a>
              </li>
              <li class="nav-item">
                <a class="nav-link me-2 text-uppercase" href="gallery.html">Gallery</a>
              </li>
              <li class="nav-item">
                <a class="nav-link me-2 text-uppercase" href="about.html">About</a>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link ms-2 text-uppercase dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                 Category
                </a>
              ...
              <li class="nav-item">
                <a class="nav-link ms-2 text-uppercase" href="contact.html" tabindex="-1">Contact</a>
              </li>
            </ul>
            <form class="d-flex">
...
document.querySelector("footer").innerHTML += `
 <section class="footer-bg py-4 py-md-5 py-xl-8 border-top border-light">
        ...
        <div class="row gy-4 gy-lg-0 justify-content-xl-between">
          <div class="col-12 col-md-4 col-lg-3 col-xl-2">
            <div class="widget">
              <a href="#!">
              <div class="footlogo">
                <img class="w-25" src="assets/images/Untitled_design__2_-removebg-preview (1).png" alt="BootstrapBrain Logo" width="175" height="57">
                </div>
              </a>
            </div>
          </div>
    ...
    <div class="foot-bg py-4 py-md-5 py-xl-8 border-top border-light-subtle">
      <div class="container overflow-hidden">
        <div class="row gy-4 gy-md-0 align-items-md-center">
          <div class="col-xs-12 col-md-7 order-1 order-md-0">
            ...
            <div class="credits text-secondary text-center text-md-start mt-2 fs-8"> Built by <a href="https://bootstrapbrain.com/" class="link-secondary text-decoration-none">Muhammad Waleed Rehman</a>  <span class="text-primary">&#9829;</span>
            </div>
          </div>
